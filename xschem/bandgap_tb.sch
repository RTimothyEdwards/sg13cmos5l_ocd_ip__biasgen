...
N -220 290 -220 390 {lab=vtrim[15:2]}
...
N -330 350 -330 390 {lab=vtrim[15:14]}
...
"}
C {devices/vsource.sym} -220 420 0 0 {name=Vtrim[13:0] value=1.2 savecurrent=false}
...
C {devices/vsource.sym} -330 420 0 0 {name=Vtrim1[1:0] value=0 savecurrent=false}
C {lab_pin.sym} -330 350 0 0 {name=p7 sig_type=std_logic lab=vtrim[15:14]}
C {lab_pin.sym} -220 290 0 0 {name=p4 sig_type=std_logic lab=vtrim[13:0]}
