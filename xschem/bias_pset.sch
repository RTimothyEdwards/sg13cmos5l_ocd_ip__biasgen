...
T {In this cell, the middle shield is connected to pbias.} 320 -600 0 0 0.3 0.3 {}
N 190 -510 230 -510 {
lab=avdd}
N 190 -570 190 -540 {
lab=avdd}
...
C {devices/iopin.sym} 410 -480 0 1 {name=p4 lab=shld3}
C {lab_pin.sym} 450 -480 0 1 {name=p10 sig_type=std_logic lab=shld3}
